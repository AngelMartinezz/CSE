...
class Car(object):
    def __init__(self,color, name, model, horespower):
        self.name = name
        self.color = color
        self.model = model
        self.running = horespower
        self.running = False
        self.passengers = 0
    ...
    def go_for_drive(self, passangers):
        print("%d passangers get in" % passangers)
        ...
        self.drive_forward()
        self.turn_off()
        print("%d passangers get out" % passangers)
        self.passengers = 0


my_car = Car("red", "Teala", "X", 9001)
